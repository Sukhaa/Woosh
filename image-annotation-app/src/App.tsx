      ...
      <main className="flex-1 w-full flex flex-col items-center justify-center">
        <header className="mb-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-2 tracking-tight">
            Infographic Image Annotator
          </h1>
          <p className="text-sm text-gray-500 font-medium mb-8">
            Upload an image to start annotating. Draw shapes, add labels, and export your infographic!
          </p>
        </header>
        {currentImage && (
          <div className="w-full flex flex-col items-center">
            <div className="w-full flex justify-center mt-6 mb-10">
              <Toolbar
                ...
                className="rounded-full shadow-2xl bg-white/80 backdrop-blur-md border border-gray-200 px-6 py-3"
              />
            </div>
